...
export class Player extends GameObject {
  ...
  draw(renderer: Renderer): void {
    ...
    ctx.quadraticCurveTo(-r * 0.30, 0, -r * 0.55, r * 0.60);
    ctx.closePath();
    ...
    ctx.beginPath();
    ctx.moveTo(-r * 0.70,  r * 0.02);
    ctx.quadraticCurveTo(0, -r * 0.04, r * 0.70, r * 0.02);
    ...
    ctx.quadraticCurveTo(r * 0.26, 0, r * 0.32, r * 0.20);
    ...
    ctx.fill();
    ctx.beginPath();
    ctx.arc(r * 0.50, -r * 0.12, r * 0.045, 0, Math.PI * 2);
